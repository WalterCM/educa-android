...
class CustomListAdapter extends ArrayAdapter<Card> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final Runnable onClick = getItem(position).getOnClick();
            ...
            if (convertView == null){
                ...
                convertView.setOnClickListener(new View.OnClickListener() {
                   public void onClick(final View v) {
                       onClick.run();
                       /*try {
                           Log.e("TAG: ", "TRYING TO GET INTO " + newActivityName);
                           //Class<?> c = Class.forName(newActivityName);
                           Intent intent = new Intent(CustomListAdapter.this.getContext(), Courses.class);
